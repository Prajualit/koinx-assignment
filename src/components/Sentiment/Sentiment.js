  ...
  return (
    <div className="sm:px-12 px-3 xl:pr-[68px] pb-12">
      <div className="w-full xl:w-[70%] bg-white rounded-[8px] p-[24px] px-[28px] flex flex-col space-y-12">
        ...
        <div className="flex space-x-3 max-lg:space-x-0 max-lg:flex-col max-lg:space-y-3">
          <div className="bg-[#E8F4FD] p-[18px] flex space-x-1 items-start rounded-[8px] sm:w-[456px] h-[204px] ">
            <Image
              className="sm:w-[44px] h-[44px] "
              width={28}
              height={28}
              src={sentiment1}
              alt=""
          ...
          <div className="bg-[#EBF9F4] p-[18px] flex space-x-1 items-start rounded-[8px] sm:w-[456px] h-[204px] ">
            <Image
